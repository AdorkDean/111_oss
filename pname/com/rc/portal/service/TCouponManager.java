...
public interface TCouponManager {
    ...
    int updateConpon(TCoupon record) throws SQLException;

    Long insertOrTCouponCard(TCoupon record,String id) throws SQLException;

    void createCardEdit(TCoupon record) throws SQLException;
}

...
import com.rc.portal.dao.CImageDAO;
...
public class CImageDAOImpl implements CImageDAO {
    ...
    public Integer insert(CImage record) throws SQLException {
		return (Integer)        sqlMapClient.insert("c_image.ibatorgenerated_insert", record);
    }

    public Integer insertSelective(CImage record) throws SQLException {
		return (Integer)        sqlMapClient.insert("c_image.ibatorgenerated_insertSelective", record);
    }

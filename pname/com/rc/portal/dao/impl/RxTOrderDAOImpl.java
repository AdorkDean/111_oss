...
public class RxTOrderDAOImpl implements RxTOrderDAO {
    ...
    public String getRxOrderSn(int len) throws SQLException{
    	Map<String,Object> paramMap = new HashMap<String,Object>();
    	paramMap.put("len", len);
    	paramMap.put("type", 1);
    	String rxOrderSn =(String) sqlMapClient.queryForObject("rx_t_order.select_p_rx_order_sn_call", paramMap);
    	while(rxOrderSn==null||"".equals(rxOrderSn)||"-1".equals(rxOrderSn)){
    		rxOrderSn =(String) sqlMapClient.queryForObject("rx_t_order.select_p_rx_order_sn_call", paramMap);
    	}
    	return rxOrderSn;
    }

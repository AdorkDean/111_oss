...
public class TReturnItemDAOImpl implements TReturnItemDAO {
	...
	public TReturnItem selectByPrimaryKey(Long id) throws SQLException {
		TReturnItem key = new TReturnItem();
		key.setId(id);
		TReturnItem record = (TReturnItem) sqlMapClient.queryForObject(
				"t_return_item.ibatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	@Override
	public List<TReturnItem> selectListByReturnId(Map<String, Object> map) throws SQLException {
		List<TReturnItem> list = sqlMapClient.queryForList("t_return_item.selectListByReturnId", map);
		return list;
	}
}

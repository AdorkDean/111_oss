...
public class CPositionDAOImpl implements CPositionDAO {
    ...
    public Integer insert(CPosition record) throws SQLException {
		return (Integer)        sqlMapClient.insert("c_position.ibatorgenerated_insert", record);
    }

    public Integer insertSelective(CPosition record) throws SQLException {
		return (Integer)        sqlMapClient.insert("c_position.ibatorgenerated_insertSelective", record);
    }

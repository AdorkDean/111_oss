 ...
 * 
 * @author user00
 * @modifyTime 2015-8-11 下午6:01:32
 */
public class TReturn {
	...
	/**
	 * 服务类型 退货 Refunds(0), 换货 exchange(1)  ,2:退款(无需退货)
	 */
	...
	public enum ReturnStatus {
		...
		// 普通方法
		public static ReturnStatus getReturnStatusByOrdinal(int index) {
			for (ReturnStatus r : ReturnStatus.values()) {
				if (r.ordinal() == index) {
					return r;
				}
			}

                ...
                <div class="swiper-wrapper" style="float:left;">
                    <div class="swiper-slide" id="big_content_1">
                        <div class="content-slide">
                        	<#if goodsDescribes?exists>
                        		<#if goods.goodsDescribes?if_exists?has_content>
...
<script type="text/javascript" src="/web/js/??idangerous.swiper.min.js,normal_goodsdetail_new.js"></script>
</body>
</html>

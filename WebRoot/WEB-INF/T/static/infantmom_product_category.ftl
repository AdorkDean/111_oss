...
<#list rss as cate>
	    ...
	    <div class="item">
		        ...
		        <div class="item-list clearfix">
		        		...
		        		<#assign did = cate3.id>
			                	<h2><span onclick="location.href='/${parentid}/${cate3.id}/ylist.html';">${cate3.category_name?default('')}</span></h2>
			                	<p>
		            	...
		            	<div class="cat-right">
                        	<a href="/" class="header-big-adv" target="_blank"><img src="/static/image/temp/category/myg_a_${cate_index+1}.jpg"/></a>
							<span>
								<img class="img-ui-1" src="/static/image/temp/category/myg_b_${cate_index+1}.jpg" onclick="window.open('/','_blank');"/>
								<img class="img-ui-2" src="/static/image/temp/category/myg_c_${cate_index+1}.jpg" onclick="window.open('/','_blank');"/>
							</span>
                    	</div>
		        </div>
	    </div>	

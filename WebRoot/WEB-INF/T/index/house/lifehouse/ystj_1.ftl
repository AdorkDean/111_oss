...
<div class="doc-recommend-info doc-recommend-info1">
	<div class="w1210">
		<p class="pathogeny">${obj.cposition.titleAll?if_exists}</p>
        <div class="doc-n-recommend clearfix">
        	<div class="doc-info">
            ...
            <div class="recommend-info">
                <a class="recommend-link clearfix" target="_blank" href="${obj.cposition.imgLink?if_exists}">

...
<div></div>
    ...
    <form action="${base}/goodsConsult/saveReplyGoodsConsult!saveReplyGoodsConsult.action" method="post" name="addInfo" id="addInfo">
    	...
    	<div class="m-contents" style="margin-top:10px;">
	    	<div class="labelnamese">是否显示：</div> 
		    	<#if tGoodsConsult.isShow?exists && tGoodsConsult.isShow?if_exists==1>
			    	<input style="width: 14px;" type="radio" name="isShow" class="i-text-cb" id="isShow1" checked="true" value="1"/><span style="border:0px; height: 15px; margin-top: 7px;" class="i-text-cb">显示</span>
			    	<input style="width: 14px;" type="radio" name="isShow" class="i-text-cb" id="isShow2" value="0"/><span style="border:0px;width:45px; height: 15px; margin-top: 7px;" class="i-text-cb">不显示</span>
				<#elseif tGoodsConsult.isShow?exists && tGoodsConsult.isShow?if_exists==0>
			    	<input style="width: 14px;" type="radio" name="isShow" class="i-text-cb" id="isShow1" value="1"/><span style="border:0px; height: 15px; margin-top: 7px;" class="i-text-cb">显示</span>
			    	<input style="width: 14px;" type="radio" name="isShow" class="i-text-cb" id="isShow2" checked="true" value="0"/><span style="border:0px;width:45px; height: 15px; margin-top: 7px;" class="i-text-cb">不显示</span>
				</#if>
    	</div>
    	<hr/>
    	<div class="m-contents" style="margin-top:10px;">
    	...
    	<div class="m-contents" style="margin-top:20px;">
	    	...
	    	<@security.authorize ifAnyGranted="ROLE_ADMIN,ROLE_ZIXUN_LIEBIAO_SUBMIT">

  ...
  <div class="shop_main" style="font-family: 'Microsoft Yahei';"> 
   <div class="sm_user"> 
    ...
    <!--查询条件开始-->
     ...
     <form name="form1" id="form1"  action="${base}/leader/leaderGoodsRecommend!leaderRecommendGoodsList.action" method="post">
         ...
         <tbody> 
          <tr> 
           ...
           <td> <input type="button"   id="buttonsub" value="查询" class="btn01" onclick="submitForm()" /> 
          		<a href="${base}/leader/leaderGoodsRecommend!addLeaderRecommendGoods.action?type=2" ><input type="button" class="btn01" value="添加" /></a>
           </td> 
          </tr> 
         </tbody> 
        </table> 

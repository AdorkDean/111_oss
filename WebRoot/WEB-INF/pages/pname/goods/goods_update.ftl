...
<form action="${base}/goods/goods!goodsUpdate.action" method="post" name="form1" id="form1" onsubmit="return tijiao()" enctype="multipart/form-data">
<div class="tabList"> 
...
<table border="0px" align="center" cellpadding="5" cellspacing="1" class="tac">
   ...
   <tr>
    ...
    <td colspan="100%">
    <input type="text" id="goodsno" name="goods.goodsno" onblur="vd(this);" title="海典编号" value="${goods.goodsno?default('')}"  maxlength="10"/>
   ...
   <tr>
	    ...
	    <input type="text" id="yiyaoguanId" onMouseOver="showyyg()" " readonly="readonly"  value="${goodsf.yiyaoguanName?default('')}" />
  ...
  <tr>
    <td colspan="4" align="center">
     ...
     <input type="button" name="cancel" id="cancel" value="取消" onclick="history.go(-1)"/>
    </td>
  </tr>
</table>
</div> 
...
<table border="0px" align="center" cellpadding="5" cellspacing="1" class="tac">
  ...
  <#list listi?if_exists as resc>
	...
	<a href="javascript:;" onclick="delImgtr('trsl_${resc.id}','${resc.id}');">删除</a>
	</td>
	</tr>
  </#list>
        ...
        <div class="_publish_content clearfix">
            <div class="_publish_title _publish_line clearfix">
                <span class="_p_t_name">Web</span>
                  <div class="_p_l_right">
                    <input class="_publish_now btn05 fr _colred" onclick="setStatus(1,${goods.id?default('')});" value="立即下架" type="button"/>
                </div>
            </div>
            <div class="_publish_line _top_line clearfix">
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox"  name="priceformbeanmodel.isPcShow" value="1" id="isx1" <#if newGoods.isPcShow?exists><#if newGoods.isPcShow==1>checked</#if></#if> />
                    <span>显示商品</span>
                </label>
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox" name="priceformbeanmodel.pcStatus" value="1" id="sta1" <#if newGoods.pcStatus?exists><#if newGoods.pcStatus==1>checked</#if></#if> />
                    <span>上架</span>
                </label>
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox" name="priceformbeanmodel.isPcTop" value="1" id="itop1" <#if newGoods.isPcTop?exists><#if newGoods.isPcTop==1>checked</#if></#if> />
                    <span>置顶</span>
                </label>
                <label class="_p_t_box">
                    <span>下架时间:</span>
                    <input type="text" name="priceformbeanmodel.pcDowndate" disabled="true" class="_p_time_box" id="endDate" onblur="setDate('endDate');" value="<#if newGoods.pcDowndate?exists>${newGoods.pcDowndate?datetime}</#if>" onfocus="WdatePicker({minDate: '#F{$dp.$D(\'beginDate\')}',endDate:'%y-%M-%d %H:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/>
                </label>
                <label class="_p_t_box">
                    <span>上架时间:</span>
                    <input type="text" name="priceformbeanmodel.pcUpdate" disabled="true" class="_p_time_box" id="beginDate" onblur="setDate('beginDate');" value="<#if newGoods.pcUpdate?exists>${newGoods.pcUpdate?datetime}</#if>" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\')}',beginDate:'%y-%M-%d %H:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/>
                </label>
            </div>
            <div class="_publish_line _top_line clearfix">
                <div class="_p_l_left">销售价格</div>
                <div class="_p_r_price">
                <input type="text" id="pcPrice" name="priceformbeanmodel.pcPrice" value="<#if newGoods.pcPrice?exists>${newGoods.pcPrice?string('0.00')}<#else>0</#if>" onblur="vd(this);" title="销售价格(pc)" maxlength="10" t_value="" o_value="" onkeypress="if(!this.value.match(/^[\+\-]?\d*?\.?\d*?$/))this.value=this.t_value;else this.t_value=this.value;if(this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?)?$/))this.o_value=this.value" onkeyup="if(!this.value.match(/^[\+\-]?\d*?\.?\d*?$/))this.value=this.t_value;else this.t_value=this.value;if(this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?)?$/))this.o_value=this.value" onblur="if(!this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?|\.\d*?)?$/))this.value=this.o_value;else{if(this.value.match(/^\.\d+$/))this.value=0+this.value;if(this.value.match(/^\.$/))this.value=0;this.o_value=this.value}"/>
        ...
        <div class="_publish_content clearfix">
            <div class="_publish_title _publish_line clearfix">
                <span class="_p_t_name">WAP</span>
                 <div class="_p_l_right">
                    <input class="_publish_now btn05 fr _colred" onclick="setStatus(2,${goods.id?default('')});" value="立即下架" type="button"/>
                </div>
            </div>
            <div class="_publish_line _top_line clearfix">
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox"   name="priceformbeanmodel.isWapShow" value="1" id="isx2" <#if newGoods.isWapShow?exists><#if newGoods.isWapShow==1>checked</#if></#if> />
                    <span>显示商品</span>
                </label>
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox" name="priceformbeanmodel.wapStatus" value="1" id="sta2" <#if newGoods.wapStatus?exists><#if newGoods.wapStatus==1>checked</#if></#if> />
                    <span>上架</span>
                </label>
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox" name="priceformbeanmodel.isWapTop" value="1" id="itop2" <#if newGoods.isWapTop?exists><#if newGoods.isWapTop==1>checked</#if></#if> />
                    <span>置顶</span>
                </label>
                <label class="_p_t_box">
                    <span>下架时间:</span>
                    <input type="text" name="priceformbeanmodel.wapDowndate" disabled="true" class="_p_time_box" id="wapDowndate" value="<#if newGoods.wapDowndate?exists>${newGoods.wapDowndate?datetime}</#if>" onfocus="WdatePicker({minDate: '#F{$dp.$D(\'wapUpdate\')}',wapDowndate:'%y-%M-%d %H:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/>
                </label>
                <label class="_p_t_box">
                    <span>上架时间:</span>
                   <input type="text" name="priceformbeanmodel.wapUpdate" disabled="true" class="_p_time_box" id="wapUpdate" value="<#if newGoods.wapUpdate?exists>${newGoods.wapUpdate?datetime}</#if>" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'wapDowndate\')}',wapUpdate:'%y-%M-%d %H:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/>
                </label>
            </div>
            <div class="_publish_line _top_line clearfix">
                <div class="_p_l_left">销售价格</div>
                <div class="_p_r_price">
                 <input type="text" id="wapPrice" name="priceformbeanmodel.wapPrice" value="<#if newGoods.wapPrice?exists>${newGoods.wapPrice?string('0.00')}<#else>0</#if>" title="销售价格(wap)" maxlength="10" t_value="" o_value="" onkeypress="if(!this.value.match(/^[\+\-]?\d*?\.?\d*?$/))this.value=this.t_value;else this.t_value=this.value;if(this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?)?$/))this.o_value=this.value" onkeyup="if(!this.value.match(/^[\+\-]?\d*?\.?\d*?$/))this.value=this.t_value;else this.t_value=this.value;if(this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?)?$/))this.o_value=this.value" onblur="if(!this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?|\.\d*?)?$/))this.value=this.o_value;else{if(this.value.match(/^\.\d+$/))this.value=0+this.value;if(this.value.match(/^\.$/))this.value=0;this.o_value=this.value}"/>
        ...
        <div class="_publish_content clearfix">
            <div class="_publish_title _publish_line clearfix">
                <span class="_p_t_name">App</span>
                 <div class="_p_l_right">
                    <input class="_publish_now btn05 fr _colred"  onclick="setStatus(3,${goods.id?default('')});" value="立即下架" type="button"/>
                </div>
            </div>
            <div class="_publish_line _top_line clearfix">
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox"  name="priceformbeanmodel.isAppShow" value="1" id="isx3" <#if newGoods.isAppShow?exists><#if newGoods.isAppShow==1>checked</#if></#if> />
                    <span>显示商品</span>
                </label>
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox" name="priceformbeanmodel.appStatus" value="1" id="sta3" <#if newGoods.appStatus?exists><#if newGoods.appStatus==1>checked</#if></#if> />
                    <span>上架</span>
                </label>
                <label class="_p_c_box _pad_left">
                    <input class="_p_checkbox" type="checkbox" name="priceformbeanmodel.isAppTop" value="1" id="itop3" <#if newGoods.isAppTop?exists><#if newGoods.isAppTop==1>checked</#if></#if> />
                    <span>置顶</span>
                </label>
                <label class="_p_t_box">
                    <span>下架时间:</span>
                     <input type="text" name="priceformbeanmodel.appDowndate" disabled="true" class="_p_time_box" id="appDowndate" value="<#if newGoods.appDowndate?exists>${newGoods.appDowndate?datetime}</#if>" onfocus="WdatePicker({minDate: '#F{$dp.$D(\'appUpdate\')}',appDowndate:'%y-%M-%d %H:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/>
                </label>
                <label class="_p_t_box">
                    <span>上架时间:</span>
                     <input type="text" name="priceformbeanmodel.appUpdate" disabled="true" class="_p_time_box" id="appUpdate" value="<#if newGoods.appUpdate?exists>${newGoods.appUpdate?datetime}</#if>" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'appDowndate\')}',appUpdate:'%y-%M-%d %H:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss'});"/>
                </label>
            </div>
            <div class="_publish_line _top_line clearfix">
                <div class="_p_l_left">销售价格</div>
                <div class="_p_r_price">
                <input type="text" id="appPrice" name="priceformbeanmodel.appPrice" value="<#if newGoods.appPrice?exists>${newGoods.appPrice?string('0.00')}<#else>0</#if>" title="销售价格(app)" maxlength="10" t_value="" o_value="" onkeypress="if(!this.value.match(/^[\+\-]?\d*?\.?\d*?$/))this.value=this.t_value;else this.t_value=this.value;if(this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?)?$/))this.o_value=this.value" onkeyup="if(!this.value.match(/^[\+\-]?\d*?\.?\d*?$/))this.value=this.t_value;else this.t_value=this.value;if(this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?)?$/))this.o_value=this.value" onblur="if(!this.value.match(/^(?:[\+\-]?\d+(?:\.\d+)?|\.\d*?)?$/))this.value=this.o_value;else{if(this.value.match(/^\.\d+$/))this.value=0+this.value;if(this.value.match(/^\.$/))this.value=0;this.o_value=this.value}"/>
...
function imgxs(datas,ids,path){
	...
	var trHtml = 
		'<tr id="trs'+imgindex+'"><td><input type="hidden" value="'+ ids+'" name="goodsf.goodsimgid" /><img src="${base}' + path + '" style="width:100px;height:100px"></td><td>'+ arr[0]+'</td><td>'+userType+'</td><td>'+isdefault+'</td><td id="img_'+ids+'" imgsort="'+arr[3]+'" ondblclick="setSort(&apos;'+ids+'&apos;)">'+arr[3]+'</td><td><a href="javascript:;" onclick="delImgtr(&quot;trs' + imgindex + '&quot;,'+ ids+');">删除</a></td></tr>';
	$("#imagev").after(trHtml);
	imgindex ++;
}
...
function tijiao() 
{
		 ...
		 {
		 	$alert('warn',$("#"+goodsno.id).attr("title")+"不能为空!");
		 	return false;
		 }
		 //简称

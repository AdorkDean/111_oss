...
<html>
 ...
 <div style="float:left;width:100%;height:auto;border:#ccc 1px solid;">
  ...
  <div class="article-title">
  	...
  	<input type="text" name="tlxgoodsarticle.title" id="title" class="art-value" maxlength="26" value=""/>
  ...
  <div class="article-title">
  	...
  	<input type="text" class="art-value" maxlength="36" value="" id="shareTitle" name="tlxgoodsarticle.shareTitle"/>
  ...
  <div class="article-title">
  	...
  	<input type="text" class="art-value" maxlength="10" value="0" id="weight2" name="tlxgoodsarticle.weight" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"  style="width:105px;" onblur="blur_weight_event()"/>
  ...
  <div class="article-title">
  	...
  	<input type="checkbox" id="checkbox_i" style="margin-top:12px;width:20px;height:20px;" onclick="checkEvent()"/>
  ...
  <ul class="article-title" id="tuijian">
    <li>
	  	...
	  	<div class="click-w">
	        <input unselectable="on" type="file" class="ifl" name="imgfile" id="imgfile1">
	        <span id="headImageTip">点此上传</span>
	        <div class="health-close" id="close_btn_1"></div>
	        <input type="hidden" value=""/>
	    </div>
	  	<span class="tips-msg" id="hdbm">海典编码：</span>
	  	<input type="text" id="hdbmv" class="haidiancode_blur_1"/>
	  	<span class="tips-msg" id="hdbm" style="margin-left:10px;">权重：</span>
	  	<input type="text" id="weightv" value="0" class="weight_1" style="width:50px;text-align:center;"/>
...
display:block;"><img src="http://img.zdfei.com/static/image/content/0(207)" style="width: 51px;" /></span></span> 
  ...
  <div style="float:left;width:100%;height:50px;margin-top:20px;margin-bottom:20px;border-top:#ccc 1px solid;padding-top:15px;">
        ...
        <input type="button" class="btn01" value="返回" onclick="window.history.back()" style="float:left;margin-left:10px;font-size:12px;"/>
  </div>
...
$(function()
{
	...
	$("#close_btn_1").click(function()
	{
    	...
    	$(this).siblings("span").children("img").remove();
    	$(this).siblings("span").html("点此上传");
    	$("#close_btn_1").parent().find("input[type=hidden]").val('');
    });
...
function saveData()
{
	  ...
	  window.setTimeout(function()
	  {
		  ...
		  for(var i=0; i<lg; i++)
		  {
		  	...
		  	map = "{'hcode':'"+hcode+"', 'weight':'"+weight+"', 'goodsImgUrl':'"+goodsImgUrl+"'}";
		  	maps += map + ",";
		  }
		  ...
		  ({
			  type: "post",
			  url: "${base}/wxam/wxam!save.action",
			  async: false,
			  data:{"title":title, "weight2":weight2, "shareTitle":shareTitle, "shareImageUrl":shareImageUrl, "content":content, "gs":maps},
			  dataType: "json",
			  success: function() 
			  {  
...
<style>a:hover {text-decoration:none;} * {font-size:12px;} .btn01 {font-size:12px;}</style>

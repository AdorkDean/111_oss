...
<body>
    ...
    <form method="get" id="form_id" enctype="multipart/form-data" action="${base}/cut/word!save.action">
    	...
    	<div class="m-contents" style="margin:0px 0px 0px 10px;">
		    ...
		    <input type="text" name="cutWord.cutword" id="cutword" style="float:left;width:200px;height:30px;line-height:30px;border:#ccc 1px solid;" maxlength="45"/>

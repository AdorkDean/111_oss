  ...
  <div class="shop_main" style="font-family: 'Microsoft Yahei';"> 
   <div class="sm_user"> 
    ...
    <!--查询条件开始-->
     ...
     <form name="form1" id="form1"  action="${base}/card/coupon!getCouponCard.action" method="post">
		...
		<input type="hidden" name="couponId" value="${couponId?default(0)}" id="couponId">		
       <div class="tbl_form"> 
        <table cellpadding="0" cellspacing="0" border="0"> 
         <tbody> 
          <tr> 
           <td> 
           <@security.authorize ifAnyGranted="ROLE_ADMIN,ROLE_COUPON_XIANGQING_DAOCHU">

...
<body> 
    ...
    <div >
    	...
    	<div class="m-contents" style="margin-top:10px;">
	    	...
	    	<input type="text"  name="userName" class="i-text-i" id="userName" value=""/>
	    		    	<div class="labelnamese">密码：</div>
	    	<input type="text"  name="" class="i-text-i" id="password" value=""/>
         ...
         <div class="m-contents" style="margin-top:10px;">
	    		...
	    		<select onchange="getfl(1)" id="gradeName" class="i-text-i" >
	    		  <#list gradeList?if_exists as resc>
	    		      <option value ="${resc.id?default(0)}">${resc.name?default('')}</option>
	    		  </#list>
	    		</select>
    		<div class="labelnamese">真实姓名：</div>
	    	<input type="text"  name="" class="i-text-i" id="realName" value=""/>
    	</div>
    	
    	<div class="m-contents" style="margin-top:10px;">
	    	<div class="labelnamese">邮箱：</div>
	    	<input type="text"  name="" class="i-text-i" id="email" value=""/>
	    		    		<div class="labelnamese">昵称：</div>
	    	<input type="text" name="" class="i-text-i" id="nickName" value=""/>
    	</div>
    	
    	<!-- 按钮 -->
    	<div class="m-contents" style="margin-top:20px;">
	    	<div class="labelnamese"></div>
	    	<@security.authorize ifAnyGranted="ROLE_ADMIN,ROLE_HUIYUAN_TIANJIA_TIJIAO">

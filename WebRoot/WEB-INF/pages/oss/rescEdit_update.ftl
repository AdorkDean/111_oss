...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    ...
    <td valign="top">
    <form action="${base}/user/rescEdit!updateResc.action" id="">
				      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_input">
				  	<tr >
				    	<td width="10%">名称：</td>
				    	<td width="20%"><input name="resc.name" type="text"  class="input" value="${resc.name?default('')}"/></td>
				    	<td>&nbsp;<input name="resc.id" type="hidden" value="${resc.id?default('')}"/><input name="resc.editable" type="hidden" value="${resc.editable?default('')}"/></td>
				    	<td>&nbsp;</td>
				    </tr>
				  	<tr>
					    <td>类型：</td>
					    <td><input  type="text" name="resc.resType" class="input" value="${resc.resType?default('')}" readonly/></td>
					    <td>&nbsp;</td>
					    <td>&nbsp;</td>
				    </tr>
				    <tr>
					    <td>资源URL：</td>
					    <td><input  type="text" name="resc.resString" class="input" value="${resc.resString?default('')}"  /></td>
					    <td>&nbsp;</td>
					    <td>&nbsp;</td>
				    </tr>
				    <tr>
					    <td>排序号：</td>
					    <td><input  type="text" name="resc.priority" class="input" value="${resc.priority?default('')}" readonly/></td>
					    <td>&nbsp;</td>
					    <td>&nbsp;</td>
				    </tr>
				    <tr>
					    <td>资源描述：</td>
					    <td><input  type="text" name="resc.descn" class="input" value="${resc.descn?default('')}"/></td>
					    <td>&nbsp;</td>
					    <td>&nbsp;</td>
				    </tr>
				    <tr>

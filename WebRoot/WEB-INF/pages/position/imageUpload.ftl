   ...
   <div class="sm_user"> 
    <div class="order"> 
     <div id="order_form" class="order_form" style="width:95%;"> 
       <div class="tbl_form"> 
    <form action="${base}/position/uploadImage!goPage.action" name="form1" id="form1" method="post">
        ...
        <table cellpadding="0" cellspacing="0" border="0"> 
         ...
         <tbody> 
          <tr> 
           ...
           <span style="margin-left:22px;">类型 ：<span><select name="imgType" style="width:80px;"><option value="1" <#if imgType?default('')==1>selected="true"</#if>>PC</option></select>
           </td> 
           <td>
          ...
          <tr> 
           <td><p>选 择 图 片：</p></td> 
           <td> <p><input type="file" name="imgfile" id="imgfile" class="input input_v1" onchange="$_checkfile(this.id,'0.3')" style="width:100px;"/>（小于300KB）</p></td> 
           <td style="text-align:right;"><p>图 片 名 称：</p></td> 
           <td> <input type="text" id="imgName" class="input input_v1"/></td> 
           <td colspan="2">
           <select id="imgtype" style="width:110px;"><option value="1">PC</option><!--option value="2">WAP</option><option value="3">APP</option--></select>

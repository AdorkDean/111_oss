...
到第
  <input id="pageNext" name="pageInfo.page" type="text" size="2"  style="width:25px; text-align:center; color:#ff0000"/>
  页
    <label>
    <input type="button" class="down_bot4" name="Submit" value="转到" onclick="goPage(document.getElementById('pageNext').value);">
   </label>
</div>  

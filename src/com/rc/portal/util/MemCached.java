...
public class MemCached {
	...
	static {
		String serversV = InfoUtil.getInstance().getInfo("memcache", "MEMCACHE_SERVERS");
		String weightsV = InfoUtil.getInstance().getInfo("memcache", "MEMCACHE_WEIGHTS");
...
//		System.out.println(MemCached.getmcc().add("test0", "zhangyong"));
////		System.out.println(MemCached.getmcc().get("tk_areaweight_isupdate"));
//		System.out.println(MemCached.getmcc().get("test"));
		System.out.println(MemCached.getmcc().delete("BB8EE9C2-7A9D-4D56-D5FC-1BE3E0F1EEF5"));
	}
}

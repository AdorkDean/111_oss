...
//		s = Replace(s, " ", "&nbsp;");
	...
	*/
	 ...
	 * @since  1.0.0
	 */
	public static String regMode( String str,String preStr,String endStr)
	{
		if( str != null )
		{
	...
	public static String spaceSplit(String str){
		str = str.trim();
		String[] strs = str.split("\\s+");//判断是否以空格分割
		String s = "";
		for (int i = 0; i < strs.length; i++) {
			if("操作".equals(strs[i])||"序号".equals(strs[i])){
				break;
			}else {
				s = s+ strs[i] +"#";
			}
	 ...
	 * @exception <BR>
	 */
	public static List<String> excelExport(String paramStr) {
	...
	{
		//spaceSplit("   用户名          收货人收货人手机号          药品名称         价格          数量          合计         取消原因         审核状态         处理状态         完结状态         预定时间          操作       ");
		//System.out.println(regMode("收益流水号#订单编号#支付时间#订单状态#订单金额#返佣时间#返佣金额#用户昵称#领秀姓名", "list.add(", ");"));
		...
		//		Object aa = null;
		//		String bb = "  aaaa  ";
//		System.out.println(regexMode("salfa是地方啦多少积分小逸"));

//		try
//		{
//			String s = "salfa是地方啦多少积分小逸\uD83D\uDC2F\uD83D\uDC2F";
//			System.out.println( StringUtil.filterOffUTF8Mb4( s ) );
